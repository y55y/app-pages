...
<div style="text-align: center; line-height: 1.6;"><span style="font-family: arial, helvetica, sans-serif; font-size: 18px;"><strong style="font-size: 18px; line-height: 1; padding: 0;">{%business_name%}</strong></span></div>
<div style="text-align: center; margin-top: 3px; font-size: 10px; direction: ltr;">
<div><span style="font-family: arial, helvetica, sans-serif;">{%site_address1_en%}</span></div>
<div><span style="font-family: arial, helvetica, sans-serif;">{%site_address2_en%}</span></div>
<div><span style="font-family: arial, helvetica, sans-serif;">{%site_bn1_label_en%}: {%site_bn1_en%}</span></div>
</div>
</td>
...
<div style="text-align: center; line-height: 1.6;"><span style="font-family: arial, helvetica, sans-serif; font-size: 18px;"><strong style="font-size: 18px; line-height: 1; padding: 0;">{%site_business_name%}</strong></span></div>
