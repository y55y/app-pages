...
<tr>
<td style="width: 50%;">
<h3 style="margin-top: 0px; margin-bottom: 0px;"><span class="mceNonEditable">{%business_name%}<br /><span style="font-size: 10pt;">&nbsp;{{#site_bn1}} {{site_bn1_label}}: {{site_bn1}} {{/site_bn1}} </span></span></h3>
</td>
<td style="width: 50%; text-align: left;">
<h3 style="text-decoration: underline; margin-top: 0px; margin-bottom: 0px;">سند قبض</h3>
...
<p style="margin: 0px;"><strong>استلمنا من السيد:&nbsp;{{#client_business_name}} {{client_business_name}} {{/client_business_name}} {{^client_business_name}} {{journal_account_name}} {{/client_business_name}} </strong></p>
