...
{%html_sticky_header%}
  <div class="invoice-inner">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="center" valign="top"><div><img  id="logo" class="editable-area" src="{%logo%}" width="{%logo-width%}" height="{%logo-height%}"  /></div></td>
      </tr>
      <tr>
    ...
    <div class="invoice-address">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="50%" align="right" valign="top"><table  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td valign="top" ><strong id="field1" class="editable-area">{%field1%}</strong></td>
                <td valign="top"><div id="client_info" style="padding-right:20px;" class='editable-area'>{%client_info%}</div></td>
              </tr>
              <tr id="shipping_options" style="display:none;">
                <td valign="top" ><br/>
                  <strong id="label_ship" class='editable-area'>{%label_ship%}</strong></td>
                <td valign="top"><br/>
                  <div  id="ship_info" style="padding-right:20px;" class='editable-area'>{%ship_info%}</div></td>
              </tr>
            </table></td>
          <td width="50%" valign="top" align="left"><table  border="0" cellspacing="0" cellpadding="0" align="left">
              <tr>
                <td>
<div class="qr-code">{%sa_qr_code_image%}<br/></div>
<div style="text-align:left;" id="business_info" class='editable-area'>{%business_info%}</div></td>
              </tr>
            </table>
...
<tr {%refund_invoice_number_condition%}>
            ...
            <custom_field id="custom_fields" class='editable-area'  border="0" cellspacing="0" cellpadding="0" > {%custom_fields%} </custom_field></td>
        </tr>
      </table>
    </div>
