import{g as j,a as F,ag as T,s as G,_ as n,p as X,br as R,r as u,u as L,b as P,j as x,c as $,d as A,aG as W,bb as z,bs as w,aS as b,bt as O,bu as S,L as _,aI as D,aH as K}from"./index-N-KnacUP.js";function q(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function J(t){return parseFloat(t)}function Q(t){return j("MuiSkeleton",t)}F("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const Y=["animation","className","component","height","style","variant","width"];let f=t=>t,B,N,U,V;const Z=t=>{const{classes:e,variant:a,animation:s,hasChildren:o,width:r,height:i}=t;return A({root:["root",a,s,o&&"withChildren",o&&!r&&"fitContent",o&&!i&&"heightAuto"]},Q,e)},tt=T(B||(B=f`
  0% {
    opacity: 1;
  }
