...
export function getCompanyInfo(userData) {
  ...
  return {
    ...
    branch_address: cs.branch_address || cs.company_address || userData.company_address || 'الرياض، المملكة العربية السعودية',
    branch_addressE: cs.branch_addressE || cs.company_addressE || userData.company_addressE ||'Riyadh, Saudi Arabia',
    ...
    site_city: cs.city || userData.company_city || cs.site_city || 'الرياض',
    site_cityE: cs.cityE || userData.company_cityE || cs.site_cityE || 'Riyadh',
    site_state: cs.state || 'منطقة الرياض',
    site_postal_code: cs.postal_code || userData.company_postal_code || cs.site_postal_code || '12345',
