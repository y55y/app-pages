  ...
  "printableTypes": [
    {
      ...
      "templates": [
        ...
        { "tempType": "sell_invoice_pro_ar_en", "name": "فاتورة احترافية عربي-إنجليزي", "default_html": "sell_invoices/tax_invoice_pro_ar_en.txt", "displaySize": "A4" },
        { "tempType": "sell_invoice_modern_ar_en", "name": "فاتورة حديثة عربي-إنجليزي", "default_html": "sell_invoices/tax_invoice_modern_ar_en.txt", "displaySize": "A4" }
      ]
    },
    {
      ...
      "params_path": "defaults/sell_invoices.params.json",
      "templates": [
        { "tempType": "sell_order_default_ar_en", "name": "امر بيع افتراضي عربي-إنجليزي", "default_html": "defulat_print_temp/order_invoice_ar_en.txt", "displaySize": "A4" },
        { "tempType": "sell_order_quotation_ar", "name": "عرض سعر عربي", "default_html": "sell_invoices/sell_order_quotation_ar.txt", "displaySize": "A4" },
        { "tempType": "sell_order_pro_ar_en", "name": "امر بيع احترافي عربي-إنجليزي", "default_html": "sell_invoices/sell_order_draft_pro_ar_en.txt", "displaySize": "A4" }
      ]
    },
    {
    ...
    },
    {
      ...
      "params_path": "defaults/sell_invoices.params.json",
      "templates": [
        { "tempType": "sell_return_default_ar_en", "name": "فاتورة مرتجع افتراضية عربي-إنجليزي", "default_html": "defulat_print_temp/sell_return_tax_invoice_ar_en.txt", "displaySize": "A4" },
        { "tempType": "sell_return_pro_ar_en", "name": "فاتورة مرتجع احترافية عربي-إنجليزي", "default_html": "sell_invoices/sell_return_pro_ar_en.txt", "displaySize": "A4" },
        { "tempType": "sell_return_modern_ar_en", "name": "فاتورة مرتجع حديثة عربي-إنجليزي", "default_html": "sell_invoices/sell_return_modern_ar_en.txt", "displaySize": "A4" }
      ]
    },
    {
    ...
    },
    {
      ...
      "templates": [
        { "tempType": "buy_invoice_default_ar_en", "name": "فاتورة مشتريات افتراضية عربي-إنجليزي", "default_html": "defulat_print_temp/buy_tax_invoice_ar_en.txt", "displaySize": "A4" },
        { "tempType": "buy_invoice_classic_ar", "name": "فاتورة مشتريات كلاسيكية عربي", "default_html": "buy_invoices/tax_invoice_ar_en.txt", "displaySize": "A4" }
      ]
    },
    {
    ...
    },
    {
      ...
      "params_path": "defaults/buy_invoices.params.json",
      "templates": [
        { "tempType": "buy_return_default_ar_en", "name": "فاتورة مرتجع مشتريات افتراضية عربي-إنجليزي", "default_html": "defulat_print_temp/buy_return_tax_invoice_ar_en.txt", "displaySize": "A4" },
        { "tempType": "buy_return_classic_ar", "name": "فاتورة مرتجع مشتريات كلاسيكية عربي", "default_html": "buy_invoices/buy_return_tax_invoice_ar_en.txt", "displaySize": "A4" }
      ]
    },
    {
    ...
    },
    {
      ...
      "params_path": "defaults/daily_entries.params.json",
      "templates": [
        { "tempType": "daily_entry_modern_ar", "name": "قيد يومية حديث", "default_html": "القيود اليومية/daily_entry_modern_ar.txt", "displaySize": "A4" },
        { "tempType": "daily_entry_default_ar", "name": "قيد يومية افتراضي", "default_html": "القيود اليومية/قالب قيد يومية.txt", "displaySize": "A4" },
        { "tempType": "daily_entry_company_ar", "name": "قيد يومية - بيانات الشركة", "default_html": "القيود اليومية/قالب قيد يومية - بيانات الشركة.txt", "displaySize": "A4" },
        { "tempType": "daily_entry_local_currency_ar", "name": "قيد يومية - عرض العملة المحلية", "default_html": "القيود اليومية/قالب قيد يومية - عرض العملة المحلية.txt", "displaySize": "A4" },
        { "tempType": "daily_entry_tax_split_ar", "name": "قيد يومية مع فصل حسابات الضريبة", "default_html": "القيود اليومية/قالب قيد يومية مع فصل حسابات الضريبة.txt", "displaySize": "A4" }
      ]
    },
    {
      ...
      "templates": [
        { "tempType": "report_header_default_ar_en", "name": "ترويسة التقارير (عربي-إنجليزي)", "default_html": "reports/report_header_ar_en.txt", "displaySize": "A4" }
      ]
    }
  ]
}`;export{e as default};
