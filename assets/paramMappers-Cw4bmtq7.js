...
export const PRINTABLE_PARAM_MAPPERS = {
  ...
  sell_inv: {
    ...
    payment_type: (data) => { const d = data.data || data; return d.PaymentType || d.PaymentMethod || d.payment_type || d.paymentMethod || d.Select_payment_Select_payment_Name || d.PaymentName || ''; },
    salesman: (data) => { const d = data.data || data; return d.Salesman || d.SalesmanName || d.SellerName || d.UserName || d.salesman || ''; },
    store: (data) => { const d = data.data || data; return d.Store || d.StoreName || d.Warehouse || d.WarehouseName || d.store || ''; },
    branch: (data) => { const d = data.data || data; return d.Branch || d.BranchName || d.branch || ''; },
