...
<div style="text-align: center; line-height: 1.6;"><span style="font-family: arial, helvetica, sans-serif; font-size: 18px;"><strong style="font-size: 18px; line-height: 1; padding: 0;">{%company_nameE%}</strong></span></div>
<div style="text-align: center; margin-top: 3px; font-size: 10px; direction: ltr;">
<div><span style="font-family: arial, helvetica, sans-serif;">{%company_addressE%}</span></div>
<div><span style="font-family: arial, helvetica, sans-serif;">{%branch_nameE%}</span></div>
<div><span style="font-family: arial, helvetica, sans-serif;">{%branch_addressE%}</span></div>
<div><span style="font-family: arial, helvetica, sans-serif;">{%branch_email_en%}</span></div>
</div>
</td>
...
<div style="text-align: center; line-height: 1.6;"><span style="font-family: arial, helvetica, sans-serif; font-size: 18px;"><strong style="font-size: 18px; line-height: 1; padding: 0;">{%company_name%}</strong></span></div>
<div style="direction: rtl; text-align: center; margin-top: 3px; font-size: 10px;">
<div><span style="font-family: arial, helvetica, sans-serif;">{%company_address%}</span></div>
<div><span style="font-family: arial, helvetica, sans-serif;">{%branch_name%}</span></div>
<div><span style="font-family: arial, helvetica, sans-serif;">{%branch_address%}</span></div>
<div><span style="font-family: arial, helvetica, sans-serif;">{%branch_email%}</span></div>
</div>
</td>
</tr>
</tbody>
...
<td style="text-align: center; border: 0;"><span style="font-family: arial, helvetica, sans-serif; font-size: 27px;"><strong style="font-size: 27px; line-height: 1.6; font-family: pnu !important;">ســــنــد صــــــرف</strong></span>
...
<div style="font-family: arial, helvetica, sans-serif; font-size: 14px; color: red; margin-top: 2px;">الرقم: #{%expense_id%}</div>
</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td style="border: 0; text-align: right; height: 30px; font-family: pnu !important;"><span style="font-family: arial, helvetica, sans-serif; font-size: 15px; font-weight: bold;">دفعنا إلى</span></td>
