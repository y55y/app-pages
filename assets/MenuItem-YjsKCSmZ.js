import{g as j,a as F,ag as T,s as L,_ as i,p as D,bn as R,r as u,u as P,b as E,j as x,c as $,d as G,aC as H,b7 as W,bo as w,aO as b,bp as O,bq as _,L as S,aE as z,aD as K}from"./index-S7T9wA8W.js";function q(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function J(t){return parseFloat(t)}function Q(t){return j("MuiSkeleton",t)}F("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const Y=["animation","className","component","height","style","variant","width"];let f=t=>t,B,N,U,V;const Z=t=>{const{classes:e,variant:a,animation:s,hasChildren:o,width:r,height:n}=t;return G({root:["root",a,s,o&&"withChildren",o&&!r&&"fitContent",o&&!n&&"heightAuto"]},Q,e)},tt=T(B||(B=f`
  0% {
    opacity: 1;
  }
