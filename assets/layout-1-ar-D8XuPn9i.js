...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<style type="text/css">
		*{ margin:0; padding:0;line-height:1.6}
		...
		.listing-table td {border-right: none !important; border-left:none !important;  text-align:right; padding:5px 6px; vertical-align:top ; border-bottom: 0 !important;}
		#listing_table th{font-weight: bold;  border-right:none !important;border-left:none !important;border-top:none !important;}
            
                  .listing-table th{background: #fff; color:#555555; border-bottom: 1px solid #C0C0C0;}
                 #listing_table tr th:last-child, #listing_table tr td:last-child{text-align:left}
                  .listing-table:nth-child(2){margin: 20px 0}

                   .listing-table:nth-child(2) td:nth-child(2){width:35%;}
...
#client_info {max-width:75%}
.invoice-info td {font-size:13px}
.invoice-num {margin-bottom:20px}
.invoice-summary-lable {font-weight:bold; color: #555555}
#field1 {margin-bottom:5px}
tr, td, th {
    page-break-inside: avoid !important;
}                                           
.qr-code img {margin-top:10px}
.listing-table:nth-child(2) strong{font-weight:normal}
.total-row, .total-row td h4 strong {font-weight: bold !important; }
.total-row {color: #555555; border-bottom: 0}
...
<div class="invoice-num" style="font-size:20px;" align="right" height="30px">
<strong class="editable-area" id="label_invoice_no"  style="line-height:50px">{%label_invoice_no%}</strong> #{%invoice_number%}
</div>

<table style="margin:20px 0" width="100%" border="0" cellspacing="0" cellpadding="0">
<tr class="invoice-info">
<td  align="right" width="60%" style="line-height:20px"><div class="editable-area" id="label_date">{%label_date%}</div>
<div align="right">{%invoice_date%}</div>
<br>
<div class="editable-area" id="label_due_date">{%label_due_date%}</div>
...
<td align="right" valign="top">
 <div id="field1" class="editable-area">من: </div>
...
cell1.classList.add('invoice-summary-lable')
cell1.innerHTML = "ملخص الفاتورة"
cell1.style.cssText = "font-size:13px;"

var selectedForBack = select("#listing_table th,  .listing-table:nth-child(2) tr:nth-child(1) td:nth-child(n+2)")
