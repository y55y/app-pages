...
.created-time-lable {padding-left:20px; font-weight:700}
.created-time {    padding-left: 20px;}
...
#listing_table tr td:first-child, #listing_table tr th:first-child {text-align:left}
</style>
	<body>
...
<tr {%refund_invoice_number_condition%}>
                                ...
                                <td  style="padding-left:20px;" align="left" >{%refund_invoice_number%}</td>
										...
										<td  style="padding-left:20px;" align="left">{%invoice_date%}</td>
                                            ...
                                            <tr>
                                                                                 <td align="right" class="created-time-lable">Time</td>
                                                                                 <td align="left" class="created-time" style="padding-left:20px;">{%created_time%}</td>
                                       </tr>
								</table>
...
function addQtyRow(){
    ...
    var listingTable = document.querySelector('#listing_table')
        ...
        for (var i = 0; i < listingTable.rows[0].cells.length; i++) {
            ...
            document.querySelector('.total-qty-row td:first-child').innerHTML = 'Total Qty'
        }
}
