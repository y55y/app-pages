...
<div class="Prow Left"><span style="font-size: 22px; font-weight: bold;">إيصال استلام</span></div>
<div class="Prow Right">
<p style="direction: rtl;">رقم: <span>{%invoice_payment_No%}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;التاريخ: <span>{%date%}</span></p>
</div>
<div stlye="clear:both;">&nbsp;</div>
</div>
<br />
<table style="border: 0; direction: rtl;" cellspcing="0" cellpadding="0" width="100%">
<tbody>
<tr>
...
<div class="Prow">
<p><span>من: </span> {%client_business_name%}</p>
</div>
<div class="Prow">
<p><span>المبلغ: </span> {%amount%}&nbsp;{%currency_code%} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span>بواسطة: </span> {%payment_method%}</p>
</div>
<div class="Prow">
<p><span>فاتورة: </span> #{%invoice_no%}</p>
</div>
<div class="Prow">
<p><span>المستلم: </span> {%staff_member_name%}</p>
</div>
<div class="Prow">
<p><span>الخزينة: </span> {%treasury_name%}</p>
</div>
<div class="segnatures Left">
<h4>التــوقــيع</h4>
</div>
<div class="clearfix"></div>
</div>
