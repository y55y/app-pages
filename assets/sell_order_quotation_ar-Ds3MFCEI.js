...
<body>
  <main class="page">
    ...
    <section class="notes"><div class="notes-title">تفاصيل التجديد:</div><div>هذا العرض يشمل السنة الأولى فقط. يتم تجديد الخدمة سنوياً بعد انتهاء السنة الأولى حسب الأسعار والشروط السارية وقت التجديد. قيمة التجديد السنوي المتوقعة: {%next_years_renewal%} ريال.</div></section>
