  ...
  <div class="page">
    <div class="invoice-wrap">
      <div class="invoice-inner">
          ...
          <table width="100%">
            <tr>
              <td style="width: 30%; text-align: right; vertical-align: top; direction: rtl; font-size: 10px;">
                <div style="font-size: 16px; font-weight: bold; color: #333;">{%supplier_name%}</div>
                <div style="margin-top: 4px;">{%supplier_address%}</div>
                <div>الرقم الضريبي: {%supplier_vat%}</div>
                <div>السجل التجاري: {%supplier_crn%}</div>
              </td>
              ...
              <td style="width: 30%; text-align: left; direction: ltr; font-size: 10px;">
                <div style="font-size: 16px; font-weight: bold; color: #333;">{%supplier_nameE%}</div>
                <div style="margin-top: 4px;">{%supplier_addressE%}</div>
                <div>VAT Number: {%supplier_vat%}</div>
                <div>CR Number: {%supplier_crn%}</div>
              </td>
            </tr>
          </table>
        </div>
            ...
            <tr>
              ...
              <td style="width: 50%; vertical-align: top;">
                <div class="info-box">
                  ...
                  <div>الرقم الضريبي / VAT: {%company_vat%}</div>
                  <div>السجل التجاري / CR: {%company_crn%}</div>
                </div>
              </td>
            </tr>
          </table>
        ...
        <!-- TERMS AND BRANCH INFO -->
        <div class="invoice-section">
          <table width="100%">
            <tr>
              <td style="width: 50%; text-align: right; vertical-align: top;">
                <div class="info-box">
                  <div class="info-title">شروط وأحكام / Terms & Conditions</div>
                  <div style="font-size: 11px; line-height: 1.6;">
                    <div>{%payment_terms%}</div>
                    <div style="margin-top: 4px;">{%delivery_terms%}</div>
                  </div>
                </div>
              </td>
              <td style="width: 50%; text-align: right; vertical-align: top;">
                <div class="info-box">
                  <div class="info-title">الفرع / Branch</div>
                  <div style="font-size: 10px;">
                    <div>{%branch_name%}</div>
                    <div style="direction: ltr; text-align: left; color: #6c757d;">{%branch_nameE%}</div>
                  </div>
                </div>
              </td>
            </tr>
