...
<div>
<style><!--
        img {height: 0.8cm !important;}
        #barcode_template{margin: 0 auto !important; margin-bottom: 0 !important;}
        
--></style>
<div>
<div class="num_contain" style="font-size: 12px; width: 95%; margin: auto;">
<div style="text-align: center;"><span class="product_unit_price">{%product_name%}</span></div>
<div style="text-align: center; margin: 2px 0;"><span style="float: right;" class="product_unit_price">{%product_unit_price_with_tax%}</span><span style="float: left;" class="product_unit_price">#{%product_code%}</span></div>
</div>
...
<div class="barcode_img_container" style="text-align: center;">{%product_barcode_number%}</div>
</div>
</div>
