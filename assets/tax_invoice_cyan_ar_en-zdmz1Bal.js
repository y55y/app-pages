    ...
    <div class="invoice-main">
      ...
      <div class="content">
        ...
        <table class="items-table">
          <thead>
            <tr>
              <th style="width: 7%;">م<br/><span style="font-size: 9px; opacity: 0.8;">No.</span></th>
              <th style="width: 43%;">الوصف<br/><span style="font-size: 9px; opacity: 0.8;">Description</span></th>
              <th style="width: 12%;">الكمية<br/><span style="font-size: 9px; opacity: 0.8;">QTY</span></th>
              <th style="width: 14%;">السعر<br/><span style="font-size: 9px; opacity: 0.8;">Price</span></th>
              <th style="width: 11%;">الخصم<br/><span style="font-size: 9px; opacity: 0.8;">Disc.</span></th>
              <th style="width: 13%;">الإجمالي<br/><span style="font-size: 9px; opacity: 0.8;">Total</span></th>
            </tr>
          </thead>
          <tbody>
            {% for item in items %}
        ...
        <div class="note-section">
          <div class="note-card">
            <div class="note-header">الملاحظات / Notes</div>
