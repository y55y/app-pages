        ...
        <table class="title-bar-table">
          <tr>
            ...
            <td style="width: 25%; vertical-align: middle;">
              ...
              <div style="font-size: 12px; font-weight: 600; color: var(--primary-dark); text-align: left; margin-top: 4px;">{%invoice_date%}</div>
            </td>
          </tr>
        </table>
      </div>
      ...
      <div class="content">
        ...
        <table class="items-table">
          <thead>
            <tr>
              <th style="width: 5%;">#</th>
              <th style="width: 10%;">الكود<br/><span style="font-size: 9px; opacity: 0.8;">Code</span></th>
              <th style="width: 35%;">الوصف<br/><span style="font-size: 9px; opacity: 0.8;">Description</span></th>
              <th style="width: 10%;">الكمية<br/><span style="font-size: 9px; opacity: 0.8;">QTY</span></th>
              <th style="width: 13%;">السعر<br/><span style="font-size: 9px; opacity: 0.8;">Price</span></th>
              <th style="width: 12%;">الخصم<br/><span style="font-size: 9px; opacity: 0.8;">Disc.</span></th>
              <th style="width: 15%;">الإجمالي<br/><span style="font-size: 9px; opacity: 0.8;">Total</span></th>
            </tr>
          </thead>
          <tbody>
            {% for item in items %}
            <tr>
              <td style="font-weight: 600;">{% item.no %}</td>
              <td>{% item.code %}</td>
              <td style="text-align: right; padding-right: 8px;">{% item.description %}</td>
              <td>{% item.qty %}</td>
              <td>{% item.price %}</td>
              <td>{% item.discount %}</td>
        ...
        <div class="bank-section">
          <div class="bank-card">
            ...
            <div class="bank-body">
              <div class="bank-name">بنك الراجحي</div>
              <div class="bank-name-en">Al Rajhi Bank</div>
              <div class="iban-label">رقم الآي بان (IBAN)</div>
              <div class="iban-value">SA0380000618608016464996</div>
              <div class="account-label">رقم الحساب / Account Number</div>
              <div class="account-value">618608016464996</div>
            </div>
          </div>
        </div>
