...
#business_info, #client_info{color:#87a4be; width:90%; margin-right:auto}
table#custom_fields:first-child tr td{text-align:left !important}
        ...
        <div class="invoice-inner">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="    padding-bottom: 20px;">
                <tr>
                    ...
                    <td width="60%" align="right" valign="top" style="padding-bottom: 8px;">
                        <h1>
...
<td width="60%" align="right" valign="bottom" style="padding-bottom: 8px;">
 <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border: 1px solid #2a2c3d; padding: 12px; margin-top:50px; text-align:right">
                            <tr>
                ...
                <tr>
                    <td align="left" valign="top">
                        <div style="vertical-align:top ; color:#87a4be" align="left" id="client_info" class='editable-area'>
                            {%client_info%}
                        </div>
                    </td>
  ...
  <custom_field id="custom_fields" style="clear:both" class='editable-area'   border="0" cellspacing="0" cellpadding="0" align="left">
        {%custom_fields%}
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border: 1px solid #2a2c3d;padding: 12px;font-size: 13px; text-align:right">
                            <tr>
                                <td width="15%" style="color: #87a4be;">Paid</td>
                                <td width="25%">{%paid%}</td>
                                <td width="30%" style="color: #87a4be;">Balance Due</td>
                                <td width="30%"><strong> {%unpaid%}</strong></td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <td valign="top" align="left">
                            <table id="invoice_basics" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                 ...
                                 <!--      <custom_field id="custom_fields" class='editable-area' style="clear:both;" border="0" cellspacing="0" cellpadding="0" align="left">
                                {%custom_fields%}
                            </custom_field> -->
