...
#listing_table th:nth-child(2), #listing_table td:nth-child(2){text-align:left}
...
.label_unit_price, .label_quantity, .item_discount, .label_tax_percent, .label_tax_value, .label_subtotal, .total-table td{
        white-space: nowrap;
        direction: rtl !important;
}
.total_before_tax, #total_before_tax {display:table-cell}
			...
			<div class="invoice-inner">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td align="left" valign="top" style="width: 45%; font-size: 14px;">
							<div id="business_info" class='editable-area'>
								{%business_info%}
							</div>
						</td>
						<td valign="top" align="right">
								<p id="invoice_title" class="editable-area invoice-name">{%invoice_title%}</p><div class="qr-code">{%sa_qr_code_image%}<br/></div>
						</td>
					</tr>
				</table>
...
function calcTotalBeforeTax() {
    ...
    newHeaderCell.innerHTML = 'Total Before Tax';
