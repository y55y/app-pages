    ...
    report_content: (data) => {
      ...
      const expensesContent = \`
        <div style="display: flex; gap: 4px;">
          ...
          <div style="display: flex; flex: 1; border: 1px solid var(--border-light, #cfd4e8); font-size: 10px;">
            <span style="padding: 4px 6px; background: var(--bg-card, #fdb70012); border-left: 1px solid var(--border-light, #cfd4e8);"><strong>مصروفات وقود</strong></span>
            <span style="padding: 4px 6px; flex: 1;">\${escapeHtml(fmtMoney(pick(data.E_Fuel)))}</span>
          </div>
          <div style="display: flex; flex: 1; border: 1px solid var(--border-light, #cfd4e8); font-size: 10px;">
            <span style="padding: 4px 6px; background: var(--bg-card, #fdb70012); border-left: 1px solid var(--border-light, #cfd4e8);"><strong>مصروفات صيانة</strong></span>
            <span style="padding: 4px 6px; flex: 1;">\${escapeHtml(fmtMoney(pick(data.E_maintenance)))}</span>
          </div>
        </div>
      \`;
      ...
      const summaryContent = \`
        <div style="display: flex; gap: 4px;">
          <div style="display: flex; flex: 1; border: 1px solid var(--border-light, #cfd4e8); font-size: 10px;">
            <span style="padding: 4px 6px; background: var(--bg-card, #fdb70012); border-left: 1px solid var(--border-light, #cfd4e8);"><strong>اجمالي المصروفات</strong></span>
            <span style="padding: 4px 6px; flex: 1;">\${escapeHtml(fmtMoney(n_exp))}</span>
          </div>
          <div style="display: flex; flex: 1; border: 1px solid var(--border-light, #cfd4e8); font-size: 10px;">
