...
<head>
  ...
  <style type="text/css">
    /* === COLOR VARIABLES - Yellow Light Theme === */
    :root {
      /* Light Mode Colors - Very Light Yellow Backgrounds */
      ...
      --border-light: var(--primary-dark);
      --white: #ffffff;
      /* Header/Footer text colors - Dark for light mode */
      --header-text: #1f2937;
      --footer-text: #1f2937;
      --grand-total-text: #1f2937;
      /* Utility colors */
