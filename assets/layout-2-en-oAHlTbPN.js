...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<style type="text/css">
		*{ margin:0; padding:0;    line-height: 1.6;}
		body{ background:#ffffff;font:12px "Tahoma", Arial, Helvetica, sans-serif;}
		.invoice-wrap{ width:660px; margin:0 auto; background:#FFF; color:#2a2c3d !important;}
		/*.invoice-inner{ margin:0 30px; padding:20px 0;}*/
		.listing-table th{color: #2a2c3d; background-color: #f5f5f5;font-weight: bold; text-align:left; padding:10px 4px}
		.listing-table td{border-bottom: 1px solid #555555; text-align:left; padding:10px 6px; vertical-align:top}
...
#listing_table th:last-child, .listing-table td:last-child{width:15%}
...
.hidden {display: none;}
#target-td {width:60%; padding-left:0px !important;}
...
{%html_sticky_header%}
			...
			<div class="invoice-inner">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding: 25px 45px;" class="info-all">
					<tr>
						<td width="60%" valign="top">
							...
							<br>
							<div style="padding: 4px 0px; color:#000;font-size:14px; ">
...
var evenRows= select("#listing_table > tbody > tr:nth-child(even) > td")
var oddRows= select("#listing_table tbody tr:nth-child(odd)>*")
