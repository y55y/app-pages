...
<head>
  ...
  <title>Sales Return Invoice - فاتورة مرتجع مبيعات</title>
  <style type="text/css">
    :root {
    ...
    * {
    ...
    .bank-accounts tr.alt td {
      background: var(--bg-light);
    }

    .bank-accounts .bank-header {
      text-align: center;
      padding: 10px;
      font-size: 12px;
      font-weight: 700;
    ...
    <div class="invoice-main">
        ...
        <table class="title-bar-table">
          <tr>
            ...
            <td style="width: 50%; text-align: center; vertical-align: middle;">
              <div class="invoice-title">فاتورة مرتجع مبيعات</div>
              <div class="invoice-subtitle">Sales Return Invoice</div>
            </td>
            <td style="width: 25%; vertical-align: middle;">
      ...
      <div class="content">
          ...
          <tr>
            <td class="client-cell" style="width: 100%;">
              <div class="info-card" style="min-height: auto;">
                <div class="info-card-title">بيانات المرتجع / Return Reference</div>
                <table class="info-grid-table">
                  <tr>
                    <td style="width: 33.33%;">
                      <span class="info-label">رقم الفاتورة الأصلية / Original Invoice</span>
                      <span class="info-value">{%original_invoice_number%}</span>
                    </td>
                    <td style="width: 33.33%;">
                      <span class="info-label">رقم المرجع / Reference</span>
                      <span class="info-value">{%reference_number%}</span>
                    </td>
                    <td style="width: 33.33%;">
                      <span class="info-label">الملاحظات / Notes</span>
        ...
        <table class="items-table">
          <thead>
            <tr>
              <th style="text-align: right;">الوصف<br/><span style="font-size: 9px;">Description</span></th>
              <th>البيان<br/><span style="font-size: 9px;">Statement</span></th>
              <th>المبلغ<br/><span style="font-size: 9px;">Amount</span></th>
              <th>الضريبة<br/><span style="font-size: 9px;">VAT</span></th>
            </tr>
          </thead>
          <tbody>
            {% for item in items %}
        ...
        <table class="totals-table">
          <tr>
            <td class="label-cell">إجمالي المرتجع <span class="en">Subtotal</span></td>
            <td class="value-cell">{%subtotal%}</td>
          </tr>
          <tr class="discount-row {%discount_row_class%}">
            <td class="label-cell">المبلغ قبل الخصم (شامل الضريبة) <span class="en">Before Discount (incl. VAT)</span></td>
            <td class="value-cell">{%amount_before_discount_with_vat%}</td>
          </tr>
          <tr class="discount-row {%discount_row_class%}">
            <td class="label-cell">إجمالي الخصومات <span class="en">Discount</span></td>
            <td class="value-cell">{%total_discount%}</td>
          </tr>
          <tr class="{%discount_row_class%}">
          ...
          <tr class="grand-total">
            <td class="label-cell">إجمالي المرتجع <span class="en">Total Due</span></td>
