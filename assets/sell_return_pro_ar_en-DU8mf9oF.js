          ...
          <tr>
            <td style="width: 25%; vertical-align: middle;">
              <div class="invoice-meta" style="text-align: right;">
                <strong>رقم مرتجع المبيعات</strong><br/>
        ...
        <table class="items-table">
          <thead>
            <tr>
              ...
              <th class="col-qty">الكمية المرتجعة</th>
          ...
          <tbody>
            {% for item in items %}
            <tr>
              <td class="col-serial">{% item.display_code %}</td>
          ...
          <tr>
            <td class="totals-cell">
              <table class="totals-table">
                <tr>
                  <td class="label-cell">إجمالي قيمة المرتجع <span class="en">Subtotal</span></td>
