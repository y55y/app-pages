    ...
    items: (data) => {
      ...
      return rawItems.map((item, index) => {
        ...
        return {
          ...
          description,
          descriptionE,
          short_description: item.ShortDescription || item.short_description || item.shortDescription || item.DescriptionShort || descriptionE || description,
          short_descriptionE: item.ShortDescriptionE || item.short_descriptionE || item.shortDescriptionE || item.DescriptionShortE || descriptionE || description,
          quantity: qty,
          qty: qty,
