...
<head>
  ...
  <style type="text/css">
    /* === COLOR VARIABLES - Gold + Navy Light Theme === */
    :root {
      /* Light Mode Colors - Gold + Navy */
      --primary-color: #fdb70070;      /* Light gold tint */
      --primary-dark: #23315f;        /* Soft navy */
      --primary-light: #fdb70070;     /* Very soft gold */

      --accent-color: #f7e9b5;

      --success-color: #d1fae5;

      --text-dark: #0d1b4d;          /* Navy text */
      --text-muted: #2a345f;         /* Lighter navy */
      --text-light: #4a5477;

      --bg-light: #fdb7000d;         /* Very light gold background */
      --bg-card: #fdb70012;          /* Slightly stronger gold */

      --border-color: #23315f;       /* Navy border */
      --border-light: #cfd4e8;       /* Very light navy */

      --white: #ffffff;

      --header-text: #0d1b4d;
      --footer-text: #0d1b4d;
      --grand-total-text: #0d1b4d;
    ...
    @media (prefers-color-scheme: dark) {
      :root {
        ...
        --border-light: #fcd34d;
        --white: #ffffff;
        /* Header/Footer text colors - White for dark mode */
        --header-text: #ffffff;
        --footer-text: #ffffff;
    ...
    * {
    ...
    .info-card {
      ...
      border: 1px solid var(--border-color);      /* single border around cards */
      border-radius: 8px;
      padding: 12px 14px;
      height: 115px;
    ...
    .items-table {
      ...
      margin-bottom: 14px;
      font-size: 10px;
      border: 1px solid var(--border-color);      /* single border around invoice rows */
      border-radius: 8px;
      overflow: hidden;
      box-shadow: 0 1px 3px var(--shadow-color);
    }
    ...
    .totals-table {
      width: 100%;
      border-collapse: collapse;
      border: 1px solid var(--border-color);      /* single border around totals summary */
      border-radius: 8px;
      overflow: hidden;
      box-shadow: 0 1px 3px var(--shadow-color);
    }
    ...
    .totals-table td {
      padding: 9px 14px;
      border-bottom: none;                        /* no internal row borders */
    }
              ...
              <div class="info-card">
                ...
                <table class="info-grid-table">
                  <tr>
                    ...
                    <td style="width: 25%;">
                      <span class="info-label">الرقم الضريبي / VAT Number</span>
                      <span class="info-value">{%client_vat%}</span>
                    </td>
                    <td style="width: 25%;">
                      <span class="info-label">رقم المبنى / Building No.</span>
                      <span class="info-value">{%client_building_number%}</span>
                    </td>
                    <td style="width: 25%;">
                      <span class="info-label">اسم الشارع / Street Name</span>
                  ...
                  <tr>
                    ...
                    <td style="width: 25%;">
                      <span class="info-label">الرمز البريدي / Postal Code</span>
      ...
      <div class="footer">
        <div class="footer-content">
          <div class="footer-contact footer-contact-ar">
            {%company_address%}<br/>
            هاتف: {%company_phone%} | البريد الإلكتروني: {%company_email%} | الموقع: {%company_website%}
          </div>
          ...
          <div class="footer-contact footer-contact-en">
            {%company_addressE%}<br/>
            Tel: {%company_phone%} | Email: {%company_email%} | Website: {%company_website%}
          </div>
        </div>
      </div>
    </div>
