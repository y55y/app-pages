...
<!-- {{#journal_transactions_table_without_taxes}}--><!-- {{#JournalTransaction}}-->
<tr>
...
<!-- {{/JournalTransaction}}--><!-- {{/journal_transactions_table_without_taxes}}--><!-- {{#journal_transactions_table_without_taxes}}-->
<tr class="bold" bgcolor="#e5e5e5">
<th colspan="3">الإجمالي بدون الضريبة</th>
<th style="word-wrap: break-word;">{{journal_total_debit_without_tax}}</th>
<th style="word-wrap: break-word;" colspan="1">{{journal_total_credit_without_tax}}</th>
</tr>
<!-- {{/journal_transactions_table_without_taxes}}--> <!-- {{#tax_transactions_table}}--><!-- {{#JournalTransaction}}-->
<tr>
<td colspan="3"><!-- {{#JournalAccount}}--> {{name}} &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <!-- {{/JournalAccount}}--></td>
<td>{{currency_debit}}</td>
<td>{{currency_credit}}</td>
</tr>
<!-- {{/JournalTransaction}}--><!-- {{/tax_transactions_table}}--><!-- {{#tax_transactions_table}}-->
<tr class="bold" bgcolor="#e5e5e5">
<th colspan="3">الإجمالي مع الضريبة الضريبة</th>
<th style="word-wrap: break-word;">{{journal_total_debit}}</th>
<th style="word-wrap: break-word;" colspan="1">{{journal_total_credit}}</th>
</tr>
<!-- {{/tax_transactions_table}}--></tbody>
</table>
<table id="listing_table" class="t_table">
<tbody></tbody>
</table>
