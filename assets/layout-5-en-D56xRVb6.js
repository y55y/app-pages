...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<style type="text/css">
		*{ margin:0; padding:0;line-height:1.6}
		...
		.listing-table td{border-right: none !important;border-left:none !important; text-align:left; padding:5px 6px; vertical-align:top}
...
.labels{color:#7D9EB5}
#business_info {width:90%; margin-left:auto}
...
.listing-table:nth-child(2) tr:nth-child(n+1) td:nth-child(1) {width:40% !important}
.listing-table:nth-child(2) td {text-align:right}
#listing_table th:last-child,  #listing_table td:last-child{text-align:right}
#listing_table th:nth-last-child(2), #listing_table td:nth-last-child(2) {padding-left:25px}
#custom_fields td{text-align:left;padding:0}
.all__info_all{padding: 3px;}
#field1{color:#7D9EB5}
...
<div align="left" class="invoice-date">{%invoice_date%}</div>
 <custom_field id="custom_fields" style="clear:both" class='editable-area' border="0" cellspacing="0" cellpadding="0" >
        {%custom_fields%}
        </custom_field>
</td>
<td align="right" rowspan="3" valign="top" class="all__info_all dynamic_background">
...
<td>
<div calss="pay__info">
<span class="labels">Paid</span> &nbsp;&nbsp; {%paid%}<br>
<span class="labels">Balance Due</span> &nbsp;&nbsp; <strong>{%unpaid%}</strong>
</div>
</td>
</tr>
</table>
