...
.invoice-wrap { margin: auto !important; width: 100% !important }
		...
		*{ margin:0; padding:0;font-size: 14px;}
		...
		.listing-table td{background-color: white; border: none !important; text-align:left; padding:2px 4px; vertical-align:middle}
...
.invoice-title tr:first-child td span {
font-size: 18px;
}
.total-table:nth-child(2) tr td:last-child {
			...
			<div class="invoice-inner">
				<div class="business-info">
					<table class="business-info-tbl" width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td>{%site_address1%} {%site_address2%}</td>
						</tr>
						<tr>
							<td>{%site_city%} {%site_state%}</td>
						</tr>
						<tr>
							<td>الهاتف: {%site_mobile%}</td>
						</tr>
					</table>
				</div>
                <div class="invoice-title">
<table class="invoice-title" border="0" cellspacing="0" cellpadding="0" width="100%">
<tr>
<td style="text-align: center;">****************</td><td style="text-align: center;"><p style="font-weight: bold; font-size: 18px;">{%invoice_title%}</p><p style="font-weight: bold; font-size: 12px;">#{%invoice_no%}</p></td><td style="text-align: center;">****************</td>
				...
				<div class="invoice-address">
					<table class="invoice-info-tbl" border="0" cellspacing="0" cellpadding="0" width="100%">
                        ...
                        <tr>
                            <td><span id="field1" class="editable-area">{%field1%}</span> {%client_business_name%}</td>
                        </tr>
                        <tr>				
				...
				<div class="notes-block">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td>
                                <div class="editable-area" id="footer">الملاحظات: {%footer%}</div>
                            </td>
						</tr>
					</table>
				</div>
...
function changePayments() {
    var paymentsTd = document.querySelectorAll(".invoice-payment-listing-table tr td:first-child")
    for (i = 0; i < paymentsTd.length; i++) {
console.log(paymentsTd[i])
        if(paymentsTd[i].innerText == "Cash") {
            paymentsTd[i].innerText = "نقدي"
        } else if(paymentsTd[i].innerText == "Bank Transfer") {
            paymentsTd[i].innerText = "تحويل بنكي"
        }
    }
