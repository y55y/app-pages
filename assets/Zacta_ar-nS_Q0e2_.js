        ...
        <div class="invoice-inner">
            ...
            <div class="invoice-address">
                <table class="sellerInformation info-table" width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="inv-title" align="right" style="padding-bottom: 10px">معلومات البائع</td>
                    </tr>
                    <tr>
                        <td class="info-td">
                            <div> اسم البائع</div>
                        ...
                        <td class="info-td">
                            <div>عنوان البائع</div>
                            <span>{%site_address1%}</span>
                        </td>
                        <td class="info-td">
                            <div>رقم تسجيل القيمة المضافة للبائع </div>
                            <span>{%site_bn1%}</span>
                        </td>
                        <td class="info-td">
                            <div> رقم السجل التجاري </div>
                            <span>{%site_bn2%}</span>
                        </td>
                    </tr>
                </table>
                ...
                <table class="buyerInformation info-table" style="margin-top:10px" width="100%" border="0"
                    ...
                    <tr>
                        ...
                        <td class="info-td">
                            <div>عنوان المشتري </div>
                            <span>{%client_address%}</span>
                        </td>
                        <td class="info-td">
                            <div>رقم تسجيل القيمة المضافة للمشتري </div>
