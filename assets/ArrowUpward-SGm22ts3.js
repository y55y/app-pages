import{K as y,J as R,a7 as b,M as U,_ as o,n as _,b1 as u,r as S,U as $,Q as A,j as v,c as M,V as j,t as V}from"./index-ppQbuXrX.js";function X(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function K(t){return parseFloat(t)}function L(t){return y("MuiSkeleton",t)}R("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const N=["animation","className","component","height","style","variant","width"];let r=t=>t,p,g,m,f;const B=t=>{const{classes:a,variant:e,animation:n,hasChildren:i,width:l,height:s}=t;return j({root:["root",e,n,i&&"withChildren",i&&!l&&"fitContent",i&&!s&&"heightAuto"]},L,a)},E=b(p||(p=r`
  0% {
    opacity: 1;
  }
